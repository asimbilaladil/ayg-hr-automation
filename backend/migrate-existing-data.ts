 ...
 * 
 * This script migrates existing text-based location and manager data
 * to use the new relational structure with foreign keys.
 * 
 * Run this AFTER applying the SQL migration (migration.sql)
 * 
 * Usage:
...
async function migrateData() {
  ...
  try {
    // ============================================================
    // Step 1: Create Locations from unique candidate locations
    // ============================================================
    console.log('1️⃣  Creating locations from candidates...');
    const candidatesWithLocation = await prisma.$queryRaw<Array<{ location: string }>>`
    ...
    // ============================================================
    // Step 2: Create Users from unique hiring managers
    // ============================================================
    console.log('2️⃣  Creating hiring managers from candidates...');
    const candidatesWithManager = await prisma.$queryRaw<Array<{ hiringManager: string }>>`
    ...
    // ============================================================
    // Step 3: Create Users from unique recruiters
    // ============================================================
    console.log('3️⃣  Creating recruiters from candidates...');
    const candidatesWithRecruiter = await prisma.$queryRaw<Array<{ recruiter: string }>>`
    ...
    // ============================================================
    // Step 4: Update candidates with new foreign keys
    // ============================================================
    ...
    // ============================================================
    // Step 5: Migrate ManagerAvailability
    // ============================================================
    ...
    console.log('📊 Summary:');
    console.log(`   • ${locationMap.size} locations created`);
    console.log(`   • ${managerMap.size} managers created`);
    console.log(`   • ${recruiterMap.size} recruiters created`);
    ...
    console.log('   3. Update your code to use the new service files');
    console.log('   4. (Optional) Remove old text columns from schema after verification\n');
